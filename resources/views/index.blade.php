...
<html lang="en">
  ...
  <body id="page-top">
    ...
    <nav class="navbar navbar-expand-lg navbar-light fixed-top" id="mainNav">
      <div class="container">
        <a class="navbar-brand js-scroll-trigger" href="#page-top">Master Moto Nautika</a>
    ...
    <section class="bg-primary" id="oNama">
      <div class="container">
        <div class="row">
          ...
          <div class="col-lg-8 mx-auto text-center">
            ...
            <form action="/send#kontakt" method="POST">
              ...
              <div class="form-group text-left">
                ...
                <input type="text" name="ime" class="form-control{{ $errors->has('ime') ? ' is-invalid' : ''}}" value="{{ old('ime') }}">
              ...
              <div class="form-group text-left">
                <label for="mail">Vaš email:</label>
                <input type="mail" name="mail" class="form-control{{ $errors->has('mail') ? ' is-invalid' : ''}}" value="{{ old('mail') }}">
              ...
              <div class="form-group text-left">
                ...
                <textarea type="text" name="poruka" class="form-control{{ $errors->has('poruka') ? ' is-invalid' : ''}}" rows="5" value="{{ old('poruka') }}"></textarea>

                @if($errors->has('poruka'))
                  <div class="invalid-feedback">
                    <strong>{{ $errors->first('poruka') }}</strong>
                  </div>
                @endif
              </div>
